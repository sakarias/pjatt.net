...
function deploy {
  ...
  change_url $URL
  build
  rsync -az -e ssh --delete _site/* charlie.rockstable.net:/home/sites/pjatt.net/www/site/
  open $URL
}

function localtest {
  URL="http://pjatt.home.rockstable.net"
  change_url $URL
  build
  rsync -az -e ssh --delete _site/* rs-web01.home.rockstable.net:/home/sites/pjatt/www/
  open $URL
}
